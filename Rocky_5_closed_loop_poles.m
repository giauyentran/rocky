...
K = 0.001589;
g = 9.81;
l = 0.433;  %effective length 
a = 1/tau;           %nominal motor parameters
...
% p1 = -mag_1 * damp_r_1 + round(mag_1 * sqrt(1 - damp_r_1^2)*i, 2)   % dominant pole pair
% p2 = -mag_1 * damp_r_1 - round(mag_1 * sqrt(1 - damp_r_1^2)*i, 2)    % dominant pole pair 
p1 = -4 + 5*i
p2 = -4 - 5*i
p3 = 0;
p4 = 0;    % dominant pole pair
p5 = 0;     % dominant pole pair 
